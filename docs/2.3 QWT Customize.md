...
Next, I copied DSN5REPO into member AAA5REPO for editing. This job defines the UDFs ( User Defined Functions ) in Db2 z/OS that will be used to control who can view and administer Query Tuning jobs. Once edited, I submit the job and check for successful execution.


![cust_qwt_11](/images/cust_qwt_11.jpg)

Next, I copied DSN5RTTG into member AAA5RTTG for editing. This job defines the UDFs ( User Defined Functions ) in Db2 z/OS that will be used to control who can view and administer Query Tuning jobs. Once edited, I submit the job and check for successful execution.
