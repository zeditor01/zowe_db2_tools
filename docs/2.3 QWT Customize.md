...
Next, I copied DSN5RTTG into member AAA5RTTG for editing. This job defines the UDFs ( User Defined Functions ) in Db2 z/OS that will be used to control who can view and administer Query Tuning jobs. 
