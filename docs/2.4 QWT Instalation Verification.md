...
And now you should be able to use the Db2 for z/OS Developer Extension. Review again the General tab for connection information.


![ivp_qwt_30](/images/ivp_qwt_30.jpg)



Click on the Tuning Tab, and choose from the dropdowns the tuning server you want to use, and the tuning profile that we just created.



![ivp_qwt_33](/images/ivp_qwt_33.jpg)


Now, Start a project (SQLPLAY) and Create an SQL file of type .sql ( testsql.sql ). Enter your most favourite SQL query of all time.

Click the line with the SQL statement, right mouse click, and choose SQL Tuning Options.


![ivp_qwt_35](/images/ivp_qwt_35.jpg)

You get the option to override all the default tuning settings. For this functional test we just want to get it to work. In the SQLID field you must enter the Schema of the Explain Tables (IBMTMS) that you created earlier.


![ivp_qwt_36](/images/ivp_qwt_36.jpg)

Now highlight the entire SQL statement that you want to tune. right mouse click, and "Tune Selected SQL".


![ivp_qwt_37](/images/ivp_qwt_37.jpg)

Choose the SQL tools and advisors that you wish to invoke, and press "Tune"


![ivp_qwt_38](/images/ivp_qwt_38.jpg)

Wait for the generated jobs to complete with Success. Look at the bottom left corner of the screen, under Tuning History, to find the completed jobs. Click on each job in turn to see the tuning output.


![ivp_qwt_39](/images/ivp_qwt_39.jpg)


If you click on "Visual Explain" you will see something like the following image. The access path for my most favourite SQL query of all time is rather boring. But it served the purpose of verifying the invocation of QWT Tuning Services, from the Db2 for z/OS Developer Extension for VSCODE.

![ivp_qwt_40](/images/ivp_qwt_40.jpg)

The Access Path advisor and other advisors will tend to be more textual than visual.


![ivp_qwt_41](/images/ivp_qwt_41.jpg)


That's all folks. Congratualtions, you have setup QWT Tuning Services and tested them from VSCODE.

Follow the rest of this GitHub repository, to setup Db2 Administration Foundation in Zowe, to find another GUI that allows you to invoke QWT tuning services.
